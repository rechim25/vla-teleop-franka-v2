# franka-sanity-checks

`franka-sanity-checks` is the isolated pre-teleoperation workspace in this repository.
It is for bring-up and safety validation before future teleoperation development.
...
- Cartesian mode uses commanded pose/elbow references (`O_T_EE_d`, `elbow_d`) and a translation rate limit to reduce discontinuity reflex aborts.
